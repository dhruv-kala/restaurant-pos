...
const moduleActions: Record<string, readonly string[]> = {
  ...
  users: ['invite', 'read', 'update', 'revoke', 'activate', 'suspend', 'reset_password', 'assign_outlet'],
  roles: ['create', 'read', 'update', 'delete', 'assign', 'grant', 'revoke', 'audit'],
  menu: ['create', 'read', 'update', 'delete', 'price', 'publish', 'availability', 'assign_station'],
  ...
  payments: ['create', 'read', 'update', 'refund', 'approve_refund', 'reconcile', 'settle', 'export'],
  ...
  purchasing: ['create', 'read', 'update', 'approve', 'cancel', 'receive', 'close', 'vendor_manage'],
  ...
  employees: ['create', 'read', 'update', 'terminate', 'salary', 'performance', 'assign_role', 'assign_outlet'],
  shifts: ['create', 'read', 'update', 'delete', 'assign', 'unassign', 'publish', 'close'],
  attendance: ['read', 'check_in', 'check_out', 'correct', 'approve', 'export', 'configure', 'audit'],
