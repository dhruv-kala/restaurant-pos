...
import '../../../../shared/presentation/navigation/app_navigation_item.dart';
import '../../../../shared/presentation/navigation/app_sidebar.dart';
          ...
          Expanded(
            child: Column(
              children: [
                _TopBar(
                  title: 'Dashboard',
                  subtitle: 'Wednesday, 10 Jun 2026 · 8:42 PM',
                  initials: 'AD',
                  color: _green,
                ),
                Expanded(
                        ...
                        Row(
                          children: [
                            ...
                            _MetricCard(
                              ...
                              label: 'Active Staff',
                              value: '9',
                              sub: '3 waiters · 2 cashiers · 4 kitchen',
                            ),
                            const SizedBox(width: 16),
                            _MetricCard(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 11,
                color: subColor ?? const Color(0xFF6B7280),
              ),
            ),
          ],
        ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              name,
              style: const TextStyle(fontSize: 13, color: Color(0xFF1A2035)),
            ),
          ),
          Text(
            orders,
