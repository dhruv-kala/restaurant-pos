...
`apps/restaurant-app` (formerly `mobile-app/restaurantpos`)
...
```text
apps/restaurant-app/         Flutter prototype
apps/admin/                  README placeholder only
apps/super-admin/            README placeholder only
...
|---|---|
| `lib/screens/admin/admin_screen.dart` | `lib/features/dashboard/presentation/screens/outlet_dashboard_screen.dart` |
| `lib/screens/cashier/cashier_screen.dart` | `lib/features/pos/presentation/screens/cashier_screen.dart` |
| `lib/screens/waiter/waiter_screen.dart` | `lib/features/tables/presentation/screens/waiter_screen.dart` |
